...
conv_data_fild = ['moi_idx','billcode','no_seq','barcode','sale_qty','dc_price','sale_amt','sale_date']
...
for mart_datainfo in coll_data:
    ...
    #수집한 데이터 회원코드 연동
    memsale_query = "UPDATE " + conv_table + " AS a,(SELECT * FROM "+one_mem_table+") AS b SET a.member_no = b.member_no WHERE b.moi_idx = a.moi_idx AND concat(replace(b.sales_date,\'-\',\'\'),b.pos_no,b.rcp_no) = a.billcode and b.moi_idx = '"+mart_datainfo['mai_Company_num']+"'"
    dbfun.merge(memsale_query)
